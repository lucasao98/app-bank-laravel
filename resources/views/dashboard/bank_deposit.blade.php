    ...
    <main class="main-content">
        ...
        <div class="content">
            <div class="page-title">
                <form method="POST" action="/operations/deposit" class="transfer-form">
                    @csrf
                    <div class="input-group">
                        <label for="agencia">Agência</label>
                        <input type="text" id="agencia" name="bank_branch" placeholder="0000-0"
                            maxlength="6" pattern="\d{4}-\d{1}">
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="valor" name="deposit_value" placeholder="0.00" min="0.01"
